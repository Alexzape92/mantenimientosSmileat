...
public class DescripcionCellFactory implements Callback<TableColumn<Mantenimiento, String>, TableCell<Mantenimiento, String>> {
        ...
        return new TableCell<Mantenimiento, String>() {
            ...
            protected void updateItem(String item, boolean empty) {
                ...
                if (empty) {
                    ...
                    if(mantenimiento instanceof Preventivo)
                        setText(((Preventivo) mantenimiento).getTipo().getDescripcion());
                    else
                        setText(null);
                }
            }
