...
public class SupervisorCellFactory implements Callback<TableColumn<Mantenimiento, String>, TableCell<Mantenimiento, String>> {
        ...
        return new TableCell<Mantenimiento, String>() {
            ...
            protected void updateItem(String item, boolean empty) {
                ...
                if (empty) {
                    ...
                    setText(mantenimiento.getSupervisor().getNombre());
                }
            }
        };
    }
